        ...
        public static void Postfix(HudManager __instance)
        {
            ...
            mediumButton = new CustomButton(
                ...
                () => {
                    ...
                    string typeOfColor = Helpers.isLighterColor(Medium.target.killerIfExisting.Data.DefaultOutfit.ColorId) ? "ñæÇÈÇ¢êF" : "à√Ç¢êF";
                    float timeSinceDeath = ((float)(Medium.meetingStartTime - Medium.target.timeOfDeath).TotalMilliseconds);
                    string name = " (" + Medium.target.player.Data.PlayerName + ")";


                    if (randomNumber == 0) msg = "Ç†Ç»ÇΩÇÃñêEÇÕâΩÇ≈Ç∑Ç©? éÑÇÃñêEÇÕ " + RoleInfo.GetRole(Medium.target.player) + "Ç≈Ç∑" + name;
                    ...
                    else msg = "Ç†Ç»ÇΩÇéEäQÇµÇΩî∆êlÇÃñêEÇÕâΩÇ≈Ç∑Ç©? éÑÇéEäQÇµÇΩî∆êlÇÃñêEÇÕ " + RoleInfo.GetRole(Medium.target.killerIfExisting) + "Ç≈Ç∑" + name; //exlude mini 
