    ...
    public static class Helpers {
        ...
        public static Sprite loadSpriteFromResources(string path, float pixelsPerUnit) {
            try {
                ...
                System.Console.WriteLine("パスからのスプライトの読み込み中にエラーが発生しました: " + path);
            }
            return null;
        }
        ...
        public static Texture2D loadTextureFromResources(string path) {
            try {
                ...
                System.Console.WriteLine("リソースからのテクスチャの読み込みエラー: " + path);
            }
            return null;
        }
        ...
        public static Texture2D loadTextureFromDisk(string path) {
            try {          
                ...
                System.Console.WriteLine("ディスクからテクスチャをロード中にエラーが発生しました: " + path);
            }
            return null;
        }
        ...
        public static void refreshRoleDescription(PlayerControl player) {
            ...
            foreach (RoleInfo roleInfo in infos) {
                ...
                if (roleInfo.name == "Jackal") {
                    var getSidekickText = Jackal.canCreateSidekick ? " サイドキックを募集しますk" : "";
