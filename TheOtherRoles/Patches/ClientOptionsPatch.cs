...
namespace TheOtherRoles.Patches {
    ...
    public class OptionsMenuBehaviourStartPatch {
        ...
        private static void updateToggle(ToggleButtonBehaviour button, string text, bool on) {
            ...
            button.Text.text = $"{text}{(on ? "オン" : "オフ")}";
        ...
        public static void Postfix(OptionsMenuBehaviour __instance) {
            ...
            if ((streamerModeButton == null || streamerModeButton.gameObject == null)) {
                streamerModeButton = createCustomToggle("配信者モード: ", TheOtherRolesPlugin.StreamerMode.Value, Vector3.zero, (UnityEngine.Events.UnityAction)streamerModeToggle, __instance);

                void streamerModeToggle() {
                    TheOtherRolesPlugin.StreamerMode.Value = !TheOtherRolesPlugin.StreamerMode.Value;
                    updateToggle(streamerModeButton, "配信者モード: ", TheOtherRolesPlugin.StreamerMode.Value);
                }
            }

            if ((ghostsSeeTasksButton == null || ghostsSeeTasksButton.gameObject == null)) {
                ghostsSeeTasksButton = createCustomToggle("幽霊時全員のタスク残量確認出来るか: ", TheOtherRolesPlugin.GhostsSeeTasks.Value, Vector3.right * xOffset, (UnityEngine.Events.UnityAction)ghostsSeeTaskToggle, __instance);
                ...
                void ghostsSeeTaskToggle() {
                    ...
                    updateToggle(ghostsSeeTasksButton, "幽霊時全員のタスク残量確認出来るか: ", TheOtherRolesPlugin.GhostsSeeTasks.Value);
                }
            }

            if ((ghostsSeeRolesButton == null || ghostsSeeRolesButton.gameObject == null)) {
                ghostsSeeRolesButton = createCustomToggle("幽霊時全員の役職を確認出来るか: ", TheOtherRolesPlugin.GhostsSeeRoles.Value, new Vector2(-xOffset, yOffset), (UnityEngine.Events.UnityAction)ghostsSeeRolesToggle, __instance);
                ...
                void ghostsSeeRolesToggle() {
                    ...
                    updateToggle(ghostsSeeRolesButton, "幽霊時全員の役職を確認出来るか: ", TheOtherRolesPlugin.GhostsSeeRoles.Value);
                }
            }

            if ((ghostsSeeVotesButton == null || ghostsSeeVotesButton.gameObject == null)) {
                ghostsSeeVotesButton = createCustomToggle("幽霊時全員の投票先を確認出来るか: ", TheOtherRolesPlugin.GhostsSeeVotes.Value, new Vector2(0, yOffset), (UnityEngine.Events.UnityAction)ghostsSeeVotesToggle, __instance);
                ...
                void ghostsSeeVotesToggle() {
                    ...
                    updateToggle(ghostsSeeVotesButton, "幽霊時全員の投票先を確認出来るか: ", TheOtherRolesPlugin.GhostsSeeVotes.Value);
                }
            }
            
            if ((showRoleSummaryButton == null || showRoleSummaryButton.gameObject == null)) {
                showRoleSummaryButton = createCustomToggle("役職一覧表示: ", TheOtherRolesPlugin.ShowRoleSummary.Value, new Vector2(xOffset, yOffset), (UnityEngine.Events.UnityAction)showRoleSummaryToggle, __instance);
                ...
                void showRoleSummaryToggle() {
                    ...
                    updateToggle(showRoleSummaryButton, "役職一覧表示: ", TheOtherRolesPlugin.ShowRoleSummary.Value);
                }
            }
        }
    }
