                ...
                if (deadPlayer != null && deadPlayer.killerIfExisting != null) {
                    ...
                    if (isMedicReport) {
                        ...
                        if (timeSinceDeath < Detective.reportNameDuration * 1000) {
                            msg =  $"éÄëÃïÒçê:éEäQé“ÇÕ{deadPlayer.killerIfExisting.name}Ç≈Ç∑";
                        } else if (timeSinceDeath < Detective.reportColorDuration * 1000) {
                            var typeOfColor = Helpers.isLighterColor(deadPlayer.killerIfExisting.Data.DefaultOutfit.ColorId) ? "ñæÇÈÇ¢êF" : "à√Ç¢êF";
